...
CREATE TABLE IF NOT EXISTS `path` (
  ...
  PRIMARY KEY (`Path_ID`),
  UNIQUE KEY `PathID` (`PathID`,`PathType`) USING BTREE
...
INSERT INTO `path` (`Path_ID`, `PathID`, `PathType`, `RegionID`, `LastTimeRowUpdated`) VALUES
	...
	('43324d2b-f133-45a1-8c66-b7c6600b24d6', 'wp_cursedtomb_madrat2', 2, 0, '2015-12-10 03:22:03'),
	...
	('67e9fe60-4ffa-41cd-9422-e1d58c4e87c8', 'wp_cursedtomb_cursedspirit1', 2, 0, '2015-12-09 05:25:54'),
	...
	('9bdbf008-e4fa-4778-a0c9-9e9abf452305', 'wp_mularn_theenoga', 3, 0, '2015-12-18 21:26:54'),
	...
	('alb_wp_avalonmarsh_packhorseguardsman', 'wp_avalonmarsh_packhorseguardsman', 3, 0, '2015-10-24 06:47:15'),
