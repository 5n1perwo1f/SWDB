...
CREATE TABLE IF NOT EXISTS `languagesystemtext` (
  `TranslationId` varchar(255) NOT NULL,
  `Text` text NOT NULL,
  `TranslationUnique` varchar(255) DEFAULT NULL,
...
DELETE FROM `languagesystemtext`;
/*!40000 ALTER TABLE `languagesystemtext` ENABLE KEYS */;
